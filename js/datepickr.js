			...
			if(e.target.className) {
				switch(e.target.className) {
					...
					case 'day':
						...
						document.getElementById('datelabel').innerHTML = formatDate(new Date(this.currentYearView, this.currentMonthView, e.target.innerHTML).getTime(), this.config.dateFormat);
						this.close();
					break;
				}
			}
